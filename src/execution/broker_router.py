...
class BrokerRouter:
    ...
    def connect(self) -> bool:
        ...
        if self.dry_run:
            ...
            return True
        success = self._fp_adapter.connect()
    ...
    def _get_manager(self, symbol: str) -> Optional[OrderManager]:
        """Return the correct OrderManager for a symbol."""
        # All assets route through FP Markets in this configuration
        return self._fp_mgr
